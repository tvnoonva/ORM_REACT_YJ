...
const Groups = () => {
  ...
  const getChannels = () => {
    axios
      ...
      .then((res) => {
        console.log("채널목록 data", res.data);
  ...
  const onSaveGroup = () => {
    ...
    axios
      ...
      .then((res) => {
        console.log("channel 생성 결과:", res.data);
                                    ...
                                    <li key={keyChild}>
                                      <div className="form-check">
                                        <Input
                                          ...
                                          onChange={(e) =>
                                            //이벤트 핸들러에 이벤트와 바인딩된 data 값을 함께 전송
